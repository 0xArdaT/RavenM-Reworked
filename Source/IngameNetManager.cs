    ...
    public class IngameNetManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(PlaceMarkerKeybind)
                && GameManager.instance != null && GameManager.IsIngame(out _)
                    ...
                    if (packet.sender != OwnGUID)
                    {
                        ...
                        switch (packet.Id)
                        {
                            ...
                            case PacketType.GameStateUpdate:
                                {
                                    switch (GameModeBase.activeGameMode)
                                    {
                                        case BattleMode battleObj:
                                            {
                                            ...
                                            break;
                                        case DominationMode dominationObj:
                                            {
